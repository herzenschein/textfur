...
void catQuest(Interface *parent)
{
    parent->addText("'So you came to visit, huh', he said, calmly arranging some boxes, and then offered: 'Please have a sit'.\n\n"
            ...
            "While certainly somewhat uneasy about you unabashedly watching his old stained mattress delicately covered in green vintage sheets, Snow starts pouring some tea from the vacuum flask he always carries into the teacup he proceeds to give you.");
//    qin.read(1);
