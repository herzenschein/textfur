// KDE Deps
#include <KLocalizedString> // From KF5::I18n
...
void catFriend()
{
    ...
    comfyVar += 1;
    catQuest();
    qout << eventPlaceholder(i18n("cat")) << Qt::endl;
    qin.read(1);
    printf("\033c");
    atHome();
}
...
void rabbitFriend()
{
    qout << i18n("The Workshop Open Garage\n\n"
    ...
    comfyVar += 1;
    rabbitQuest();
    qout << eventPlaceholder(i18n("rabbit")) << Qt::endl;
    qin.read(1);
    printf("\033c");
    atHome();
}
...
void otterFriend()
{
    ...
    comfyVar += 1;
    otterQuest();
    qout << eventPlaceholder(i18n("otter")) << Qt::endl;
    qin.read(1);
    printf("\033c");
    atHome();
}
...
void lizardFriend()
{
    ...
    comfyVar += 1;
    lizardQuest();
    qout << eventPlaceholder(i18n("lizard")) << Qt::endl;
    qin.read(1);
    printf("\033c");
    atHome();
}
